...
$("#gamestarter").on("click", function(){
    $("#majorimage").attr("src", "/static/Image resources/Cave entrance.png");
    $("#gameinfo").remove();
    $("#gamestarter").remove();
    $("h1").remove();
...
$("#majorimage").on("click", function(event)
{
    ...
    console.log(coords);
    /*if($("#majorimage").attr("src") == "/static/Image resources/Boss-stage.png")
    {
...
{
    if($("#majorimage").attr("src") == "/static/Image resources/Cave entrance.png")
    {
        $("#caveentrance").remove();
        $("#majorimage").attr("src", "/static/Image resources/Cave01.png");
    }
})
...
{
    if($("#majorimage").attr("src") == "/static/Image resources/Cave01.png")
    {
        $("#cavelake").remove();
        $("#majorimage").attr("src", "/static/Image resources/Introimage.png");
        var caveambientsound = new Audio('/static/Sound effects/Water_Bubbles.mp3');
...
{
    if($("#majorimage").attr("src") == "/static/Image resources/Introsequel.png")
    {
        hascrystal = true;
        $("#hiddencrystal").remove();
        $("#bigcrystalitem").css('opacity', '1.0');
        $("#bigcrystalitem").prop('src', '/static/Tools/Big crystal fragment.png');
    }
})
...
{
    if($("#majorimage").attr("src") == "/static/Image resources/Crystalgate.png")
    {
        ...
        else if(hascrystal == true)
        {
            ...
            $("#crystalblock").remove();
            $("#majorimage").attr("src", "/static/Image resources/Crystalgateopened.png");
        }
    }
})
...
{
    if($("#majorimage").attr("src") == "/static/Image resources/Crystalgateopened.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Tunneltoothercave.png");
    }
})
...
{
    if($("#majorimage").attr("src") == "/static/Image resources/Tunneltoothercave.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Labdoor.png");
    }
})
...
{
    if($("#majorimage").attr("src") == "/static/Image resources/Labdoor.png")
    {
        $("#crystalclear").remove();
        $("#otherentrance").remove();
        $("#majorimage").attr("src", "/static/Image resources/Welcomercomputer.png");
    }
})
...
{
    if($("#majorimage").attr("src") == "/static/Image resources/Welcomercomputer.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Welcomercomputeron.png");
        var computersound = new Audio('/static/Sound effects/Computer_voice.mp3');
        computersound.play();
    }
})
...
{
    if($("#majorimage").attr("src") == "/static/Image resources/Labsegment02.png")
    {
        $("#drawer01").remove();
        $("#firstnote").css('opacity', '1.0');
        $("#firstnote").prop('src', '/static/Tools/Note01.png');
        $("#secondnote").css('opacity', '1.0');
        $("#secondnote").prop('src', '/static/Tools/Note02.png');
        $("#thirdnote").css('opacity', '1.0');
        $("#thirdnote").prop('src', '/static/Tools/Note03.png');
    }
})
...
{
    if($("#majorimage").attr("src") == "/static/Image resources/Labsegment03.png")
    {
...
$("#portalroom").on("click", function(event)
{
    if($("#majorimage").attr("src") == "/static/Image resources/Labsegment03.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Boss-stage.png");
        $("#finalboss").css('opacity', '1.0');
        $("#bosshealthbar").css('opacity', '1.0');
...
$("#axeitem").on("click", function(event)
{
    if($("#majorimage").attr("src") == "/static/Image resources/Boss-stage.png")
    {
        ...
        if(modifiedheight <= 0)
        {
            ...
            $("#secondnote").remove();
            $("#thirdnote").remove();
            $("#majorimage").attr("src", "/static/Image resources/Aveomachine portal.png");
        }
    }
})
...
{
    if($("#majorimage").attr("src") == "/static/Image resources/Aveomachine portal.png")
    {
        $("#walkthrough").remove();
        $("#majorimage").attr("src", "/static/Image resources/Closingimage.png");
    }
})
...
$("#rightmove").on("click", function()
{
    if($("#majorimage").attr("src") == "/static/Image resources/Cave01.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Cave02.png");
    }
    else if($("#majorimage").attr("src") == "/static/Image resources/Introimage.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Introsequel.png");
        $("#hiddencrystal").css('opacity', '1.0');
    }
    else if($("#majorimage").attr("src") == "/static/Image resources/Mushroomway.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Introimage.png");
    }
    else if($("#majorimage").attr("src") == "/static/Image resources/Crystalgate.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Mushroomway.png");
    }
    else if($("#majorimage").attr("src") == "/static/Image resources/Welcomercomputer.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Labsegment01.png");
    }
    else if($("#majorimage").attr("src") == "/static/Image resources/Welcomercomputeron.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Labsegment01.png");
    }
    else if($("#majorimage").attr("src") == "/static/Image resources/Labsegment01.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Labsegment02.png");
        var labambientsound = new Audio('/static/Sound effects/Bubble_Time.mp3');
        labambientsound.play();
    }
    else if($("#majorimage").attr("src") == "/static/Image resources/Labsegment02.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Labsegment03.png");
    }
})
...
{
    if($("#majorimage").attr("src") == "/static/Image resources/Cave02.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Cave01.png");
    }
    else if($("#majorimage").attr("src") == "/static/Image resources/Introsequel.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Introimage.png");
    ...
    {
        $("#majorimage").attr("src", "/static/Image resources/Crystalgate.png");
    }
    else if($("#majorimage").attr("src") == "/static/Image resources/Labsegment01.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Welcomercomputer.png");
    ...
    else if($("#majorimage").attr("src") == "/static/Image resources/Labsegment03.png")
    {
        $("#majorimage").attr("src", "/static/Image resources/Labsegment02.png");
    }
})
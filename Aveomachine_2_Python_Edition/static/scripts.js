...
$("#intro").on("click", function () {
  if ($("#background").attr("src") == "/static/Image resources/IntroImage.png") {
    $("#background").prop("src", "/static/Image resources/Intropartimage.png");
    this.innerHTML = "Main menu";
    $("#newgame").css("opacity", "0.0");
    $("#info").css("opacity", "0.0");
  } else if (
    $("#background").attr("src") == "/static/Image resources/Intropartimage.png"
  ) {
    $("#background").prop("src", "/static/Image resources/IntroImage.png");
...
$("#newgame").on("click", function () {
  ...
  $("#info").remove();
  $("#intro").remove();
  $("#background").prop("src", "/static/Image resources/Ambackground01.png");
...
function showIt(event) {
  ...
  /*x 305, 535*/
  /*y 225, 600*/
  if ($("#background").attr("src") == "/static/Image resources/Ambackground01.png") {
    if (x >= 305 && x <= 535 && y >= 225 && y <= 600) {
      alert("The safety laser lock must be turned off!");
    }
  }
  if ($("#background").attr("src") == "/static/Image resources/Ambackground02.png") {
    if (x >= 305 && x <= 535 && y >= 225 && y <= 600) {
      $("#background").prop("src", "/static/Image resources/Ambackground03.png");
    }
  }
  ...
  /*x 165, 610*/
  /*y 395, 510*/
  if ($("#background").attr("src") == "/static/Image resources/Ambackground03.png") {
    if (x >= 165 && x <= 610 && y >= 395 && y <= 510) {
      hasletter = true;
      $("#letter").prop("src", "/static/Tools/Letter.png");
  ...
  /*x 210, 290*/
  /*y 320, 405*/
  if ($("#background").attr("src") == "/static/Image resources/Ambackground04.png") {
    if (x >= 310 && x <= 575 && y >= 220 && y <= 600) {
      $("#background").prop("src", "/static/Image resources/Ambackground05.png");
  ...
  /*x 660, 715*/
  /*y 560, 690*/
  if ($("#background").attr("src") == "/static/Image resources/Ambackground05.png") {
    if (x >= 100 && x <= 200 && y >= 210 && y <= 710) {
      alert("Nothing special in!");
    } else if (x >= 670 && x <= 720 && y >= 300 && y <= 375) {
      hasred = true;
      $("#redfuse").prop("src", "/static/Tools/Red fuse.png");
      $("#redfuse").css("opacity", "1.0");
    } else if (x >= 670 && x <= 720 && y >= 440 && y <= 535) {
      hasnote = true;
      $("#littlenote").prop("src", "/static/Tools/Little note.png");
      $("#littlenote").css("opacity", "1.0");
    } else if (x >= 660 && x <= 715 && y >= 560 && y <= 690) {
      hasiron = true;
      $("#ironbar").prop("src", "/static/Tools/Crowbar.png");
  ...
  if ($("#background").attr("src") == "/static/Image resources/Ambackground05.png") {
    if (x >= 345 && x <= 500 && y >= 690 && y <= 715) {
      $("#background").prop("src", "/static/Image resources/Ambackground04.png");
    }
  }
  ...
  /*x 130, 210*/
  /*y 340, 425*/
  if ($("#background").attr("src") == "/static/Image resources/Ambackground06.png") {
    if (x >= 265 && x <= 585 && y >= 240 && y <= 600) {
      $("#background").prop("src", "/static/Image resources/Ambackground07.png");
  ...
  /*x 115, 125*/
  /*y 530, 580*/
  if ($("#background").attr("src") == "/static/Image resources/Ambackground08.png") {
    if (x >= 175 && x <= 385 && y >= 380 && y <= 590 && hasfan == false) {
      alert("Fan is needed!");
    } else if (x >= 175 && x <= 385 && y >= 380 && y <= 590 && hasfan == true) {
      $("#background").prop("src", "/static/Image resources/Ambackground09.png");
      $("#bigfan").remove();
      fanplaced = true;
    }
    if (
    ...
    $("#background").attr("src") == "/static/Image resources/Ambackground09.png"
  ) {
    if (x >= 115 && x <= 125 && y >= 325 && y <= 380 && hasred == true) {
      $("#background").prop("src", "/static/Image resources/Ambackground10.png");
      $("#redfuse").remove();
      redplaced = true;
    }
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground10.png"
  ) {
    if (x >= 115 && x <= 125 && y >= 435 && y <= 485 && hasblue == true) {
      $("#background").prop("src", "/static/Image resources/Ambackground11.png");
      $("#bluefuse").remove();
      blueplaced = true;
    }
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground11.png"
  ) {
    if (x >= 115 && x <= 125 && y >= 530 && y <= 580 && hasgreen == true) {
      $("#background").prop("src", "/static/Image resources/Ambackground12.png");
      $("#greenfuse").remove();
      greenplaced = true;
  ...
  /*x 320, 490*/
  /*y 250, 510*/
  if ($("#background").attr("src") == "/static/Image resources/Ambackground13.png") {
    if (x >= 570 && x <= 770 && y >= 380 && y <= 590 && hasiron == true) {
      $("#ironbar").remove();
      hasfan = true;
      $("#bigfan").prop("src", "/static/Tools/Fan.png");
      $("#bigfan").css("opacity", "1.0");

      hasgreen = true;
      $("#greenfuse").prop("src", "/static/Tools/Green fuse.png");
      $("#greenfuse").css("opacity", "1.0");

      hasblue = true;
      $("#bluefuse").prop("src", "/static/Tools/Blue fuse.png");
      $("#bluefuse").css("opacity", "1.0");
    } else if (x >= 320 && x <= 490 && y >= 250 && y <= 510) {
      $("#background").prop("src", "/static/Image resources/Ambackground14.png");
    }
  }
  ...
  /*x 265, 545*/
  /*y 600, 640*/
  if ($("#background").attr("src") == "/static/Image resources/Ambackground14.png") {
    if (x >= 265 && x <= 545 && y >= 600 && y <= 640) {
      $("#background").prop("src", "/static/Image resources/Ambackground13.png");
    }
  }
  ...
  /*x 610, 685*/
  /*y 360, 440*/
  if ($("#background").attr("src") == "/static/Image resources/Ambackground15.png") {
    ...
    if (x >= 105 && x <= 130 && y >= 340 && y <= 370 && greenplaced == true) {
      ...
      $("#moveright").remove();
      $("#moveleft").remove();
      $("#background").prop("src", "/static/Image resources/ClosingImage.png");
    }
  }
}
...
$("#moveright").on("click", function () {
  if ($("#background").attr("src") == "/static/Image resources/Ambackground01.png") {
    ...
    $("#background").attr("src") == "/static/Image resources/Ambackground02.png"
  ) {
    alert("I have to enter that ship!");
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground03.png"
  ) {
    $("#background").prop("src", "/static/Image resources/Ambackground04.png");
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground04.png"
  ) {
    $("#background").prop("src", "/static/Image resources/Ambackground06.png");
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground06.png"
  ) {
    $("#background").prop("src", "/static/Image resources/Ambackground13.png");
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground13.png"
  ) {
    alert("Ouch! Wall!");
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground07.png"
  ) {
    $("#background").prop("src", "/static/Image resources/Ambackground06.png");
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground08.png"
  ) {
    $("#background").prop("src", "/static/Image resources/Ambackground07.png");
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground14.png"
  ) {
    alert("Ouch! Wall!");
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground15.png"
  ) {
    $("#background").prop("src", "/static/Image resources/Ambackground14.png");
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground09.png"
    ...
    $("#background").attr("src") == "/static/Image resources/Ambackground12.png"
  ) {
    $("#background").prop("src", "/static/Image resources/Ambackground07.png");
  }
});
...
$("#moveleft").on("click", function () {
  if ($("#background").attr("src") == "/static/Image resources/Ambackground01.png") {
    ...
    $("#background").prop("src", "/static/Image resources/Ambackground08.png");
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground07.png" &&
    fanplaced == true
  ) {
    ...
    $("#background").prop("src", "/static/Image resources/Ambackground15.png");
  } else if (
    $("#background").attr("src") == "/static/Image resources/Ambackground15.png"
  ) {
    alert("Ouch! Wall!");
...
$("#gem").on("click", function () {
  if ($("#background").attr("src") == "/static/Image resources/Ambackground01.png") {
    $("#background").prop("src", "/static/Image resources/Ambackground02.png");
    $("#gem").remove();
